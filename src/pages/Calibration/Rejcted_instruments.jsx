              ...
              <tbody>
                {complaints.map((complaint) => (
                  <tr key={complaint.id} className="border-t text-[12px]">
                    ...
                    <td className={`px-2 py-2 text-center w-24 font-bold ${complaint.status === "Rejected" ? "text-red-500" : "text-green-500"}`}>{complaint.status}</td>
...
export default RejectedCalibration;