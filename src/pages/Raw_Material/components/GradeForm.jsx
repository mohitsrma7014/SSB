...
const GradeForm = ({ reloadData }) => {
    const [name, setName] = useState("");

    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post("http://192.168.1.199:8001/raw_material/grades/", { name });
            setName("");
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg mx-auto mt-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Add Grade</h2>
