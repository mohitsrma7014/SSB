...
const MissingDocumentsAlert = () => {
  ...
  useEffect(() => {
    const fetchMissingDocuments = async () => {
      try {
        const response = await axios.get('http://192.168.1.199:8001/raw_material/api/masterlist/missing_documents_report/');
  ...
  const NotificationsPopover = (
    <Popover id="notifications-popover" style={{ maxWidth: '500px', width: '500px' }}>
