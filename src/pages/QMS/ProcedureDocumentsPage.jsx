...
const [isSidebarVisible, setIsSidebarVisible] = useState(true);
  ...
  const fetchDocuments = async () => {
    try {
      setLoading(true);
      const response = await axios.get('http://192.168.1.199:8001/costumer_complaint/procedures/');
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (currentDocument.id) {
        ...
        await axios.patch(`http://192.168.1.199:8001/costumer_complaint/procedures/${currentDocument.id}/`, formData, {
          headers: {
        ...
        // Create new document
        await axios.post('http://192.168.1.199:8001/costumer_complaint/procedures/', formData, {
          headers: {
            'Content-Type': 'multipart/form-data'
          }
        });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`http://192.168.1.199:8001/costumer_complaint/procedures/${id}/`);
